        ...
        slivers: <Widget>[
                  ...
                  Expanded(
                    child: Column(
                       ...
                       Container(
                         child:  Row(
                           children: <Widget>[
                             Text("@我的",style: TextStyle(fontSize: 15,color: Colors.black),),
                             Spacer(),
                            Container(
                              child:  Image.asset(
         ...
         /* SliverToBoxAdapter(
                    ...
                    child: Column(
                      children: <Widget>[
                        Container(
                          child:  Row(
                            children: <Widget>[
                              Text("评论",style: TextStyle(fontSize: 15,color: Colors.black),),
                              Spacer(),
                              Container(
                                child:  Image.asset(
                                  Constant.ASSETS_IMG + 'icon_right_arrow.png',
          ...
          SliverToBoxAdapter(
            child: InkWell(
              onTap: (){
                Routes .navigateTo(context, Routes.msgCommentPage, transition: TransitionType.fadeIn);
          ...
          SliverToBoxAdapter(
            child: InkWell(
              onTap: (){
                Routes .navigateTo(context, Routes.msgZanPage, transition: TransitionType.fadeIn);
                      ...
                      child: Column(
                        children: <Widget>[
                          Container(
                            child:  Row(
                              children: <Widget>[
                                Text("赞",style: TextStyle(fontSize: 15,color: Colors.black),),
                                Spacer(),
                                Container(
                                  child:  Image.asset(
                                    Constant.ASSETS_IMG + 'icon_right_arrow.png',
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: <Widget>[
                              Text("测试号001",style: TextStyle(fontSize: 15,color: Colors.black),),
                              Spacer(),
                              Container(
                                child: Text("19:22",style: TextStyle(fontSize: 12,color: Colors.grey),),
                          ...
                          Container(
                            ...
                            child: Row(
                              children: <Widget>[
                                Text("明天几点吃完饭?",style: TextStyle(fontSize: 14,color: Colors.grey),),
                                Spacer(),
                                Container(
                                  margin: EdgeInsets.only(right: 15),
                                  width: 15,
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: <Widget>[
                              Text("测试号002",style: TextStyle(fontSize: 15,color: Colors.black),),
                              Spacer(),
                              Container(
                                child: Text("10:26",style: TextStyle(fontSize: 12,color: Colors.grey),),
                                margin: EdgeInsets.only(right: 15),
                              )
                            ],
                          ...
                          Container(
                            ...
                            child: Row(
                              children: <Widget>[
                                Text("可以啊,做的太好了",style: TextStyle(fontSize: 14,color: Colors.grey),),
                                Spacer(),
