              ...
              Stack(
                children: <Widget>[
                  Align(
                    ...
                    child: Text(widget.mTitle,style: TextStyle(fontSize: 16,color: Colors.black),),
                  ),
                  Align(
                      ...
                      child: Container(
                          child: GestureDetector(
                              onTapDown:
                              _handleTapDown, // Handle the tap events in the order that
                              ...
                              child:     false ? Image.asset(
                                Constant.ASSETS_IMG + 'icon_more_highlighted.png',
                                width:23.0,
                                height: 23.0,
                              ): Image.asset(
                  ...
                  Align(
                      ...
                      child: Container(
                          child: GestureDetector(
                              ...
                              onTapCancel: _handleTapCancel,
                              child:     _highlight ? Image.asset(
                                Constant.ASSETS_IMG + 'icon_back_highlighted.png',
                                width:23.0,
                                height: 23.0,
                              ): Image.asset(
