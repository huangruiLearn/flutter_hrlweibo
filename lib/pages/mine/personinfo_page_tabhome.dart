    ...
    return Container(
      color: Color(0xffEFEEEC),
       child: Column(
        ...
        top: 12.0,bottom: 12,left: 15
      ),
            child: Text('基本资料',style: TextStyle(color: Colors.black,fontSize: 16),),
          ),
          Stack(
            children: <Widget>[
              Container(
          ...
          mCommonInfo("简介",widget.desc),
           mCommonInfo("注册时间",DateUtil.getFormatTime3(  DateTime.fromMillisecondsSinceEpoch(
               widget.registtime))),
           ...
           Container(
             ...
             child: Text('查看全部微博',style: TextStyle(color: Color(0xff666666),fontSize: 14),),
           ),
         ],
      ));
  }
